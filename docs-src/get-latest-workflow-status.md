...
See [`src/get-latest-workflow-status-cli.mjs`](../src/get-latest-workflow-status-cli.mjs) (CLI entry) and [`src/github-workflows/get-latest-workflow-status.mjs`](../src/github-workflows/get-latest-workflow-status.mjs) (library module).
