...
The list of available binaries is auto-generated by [`build.mjs`](https://github.com/dimaslanjaka/bin/blob/master/build.mjs). This script scans `bin/`, `lib/`, and updates the `bin` field in `package.json`.
...
This project is licensed under the terms specified in the [LICENSE](https://github.com/dimaslanjaka/bin/blob/master/LICENSE) file.
