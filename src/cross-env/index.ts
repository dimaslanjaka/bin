...
export function crossEnv(args: string[], options: CrossEnvOptions = {}): ProcessResult | null {
...
function parseCommand(args: string[]): [Record<string, string>, string | null, string[]] {
