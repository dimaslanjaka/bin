...
const action = {
  ...
  runs: {
    ...
    steps: [
      ...
      {
        name: '🏗️ Run prepare script (if present)',
        'continue-on-error': true,
        shell: 'bash',
      ...
      {
        name: '🔗 Export composite action outputs',
        shell: 'bash',
        run: [
